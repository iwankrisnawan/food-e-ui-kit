export default function Onboarding3() {
  return (
    <>
      <section className="flex flex-col h-screen justify-between bg-[url('assets/bg-onboarding-3.png')]">
        ...
        <section className="relative text-customGray">
          <div className="w-10/12 mx-auto mb-5">
            <p className="uppercase text-2xl text-white">
              grab the <br />
              best
              <span className="text-primaryDefault"> deals </span>
              around
            </p>
            <p className="text-white">
              Grab the best deals and discounts around and save on your every
              order
            </p>
          </div>
