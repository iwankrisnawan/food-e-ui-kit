        ...
        <section className="w-10/12 mx-auto mb-10">
          ...
          <div className="flex justify-between mb-5">
            <div className="w-6/12">
              ...
              <div className="flex space-x-3 bg-customLight p-2 rounded-2xl">
                <span className="w-full">1</span>
                <button className="text-primaryDefault font-bold">-</button>
                <button className="text-primaryDefault">+</button>
              </div>
            </div>
            <div className="my-auto text-right">
              <div className="font-semibold text-xs">SUB TOTAL</div>
              <div className="text-primaryDefault text-2xl">$ 15.00</div>
            </div>
          </div>
