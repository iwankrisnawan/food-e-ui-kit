export default function Search_category() {
  return (
    <>
        ...
        <section className="w-10/12 relative h-80 mx-auto">
          ...
          <div className="mb-5">
            <div className="flex justify-between text-xs font-semibold">
              ...
              <span className="text-primaryDefault">VIEW ALL</span>
            </div>
            <div className="space-x-2 overflow-x-auto whitespace-nowrap py-2 scrollbar-hide">
              <button className="text-white bg-primaryDefault py-2 px-5 rounded-3xl space-x-3 inline-flex justify-between">
                <span>Lunch </span>
              ...
              <button className="bg-customLight py-2 px-5 rounded-3xl">
                Lunch
              </button>
              <button className="bg-customLight py-2 px-5 rounded-3xl">
                Fastfood
